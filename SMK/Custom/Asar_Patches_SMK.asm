; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMK_InsertIntegratedPatches and SMK_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMK_InsertIntegratedPatches()
...
macro SMK_ApplyPatchesPostAssembly()
